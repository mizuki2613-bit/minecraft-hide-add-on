...
execute if entity @s[scores={hide.walk=1..}] run return run function hide:reset_count
execute if entity @s[scores={hide.dash=1..}] run return run function hide:reset_count
