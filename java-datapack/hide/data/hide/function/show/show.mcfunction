...
# Restore items
execute align xyz positioned ~0.5 ~ ~0.5 run function hide:show/restore_items {target:"@n[tag=hide.vehicle,distance=0]",ignore:"minecraft:potion[custom_data={blank:1b}]"}
