...
#Restore mainhand
execute unless items entity @s mob.inventory.5 potion[custom_data={item_fill:1}] at @p[tag=hide.hiding] run summon item ~ ~ ~ {Tags:[hide.drop_mainhand],Item:{id:stone}}
