execute unless items entity @s weapon.offhand clock[custom_data={hide_stick:1}] run return run scoreboard players set @s countdown 0
...
execute if entity @s[nbt={OnGround:0}] run return run scoreboard players set @s countdown 0
