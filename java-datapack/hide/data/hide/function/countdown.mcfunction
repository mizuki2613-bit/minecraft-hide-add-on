execute unless items entity @s weapon.offhand stick[custom_data={hide_stick:true}] run return run scoreboard players set @s hide.countdown 0
execute unless items entity @s weapon.mainhand #hide:transformable_blocks run return run scoreboard players set @s hide.countdown 0
