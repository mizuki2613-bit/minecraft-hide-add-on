...
#summon armor stand
summon villager ~ ~ ~ {NoAI:1,Silent:1,NoGravity:1,Invulnerable:1,DeathTime:10000,Tags:["hide_block"],active_effects:[{id:invisibility,duration:-1,show_particles:0}],attributes:[{id:scale,base:0.4817307442426682},{id:max_health,base:0}]}
